...
def query_routes(macaroon: str, g1, secure_channel: grpc.Channel, node_dict: dict, edge_dict: dict, node_origin: str,
...
def describe_graph(macaroon, secure_channel, is_message: bool) -> dict:
    """
...
def send_payment_rpc(macaroon_dir: str, cert_dir: str, host: str, port: int, pubkey_destiny: str, payment_amount: int,
                     payment_hash, final_cltv_delta: int) -> Any:
    """
    ...
    try:
        ...
        response = stub.SendPaymentSync(request, metadata=[('macaroon', macaroon_dir)])
